...
*/
  ...
  $menu_class = \MYLAND_THEME\Inc\Menus::get_instance();
  $header_menu_id = $menu_class->get_menu_id("myland-header-menu");
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    ?>
      <ul class="navbar-nav mr-auto">
          <!-- Dynamically inserting nav menu to fit Bootstrap's style -->
          <?php 
